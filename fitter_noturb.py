...
Same as fitter.py except we force no non-thermal widths.
"""
...
class fitdict:
    ...
    def _parse(self, theta):
        ...
        x0s = theta[-3:]
        dVs = [self.linewidth(tmin), self.linewidth(tmax)]
        return tmin, tmax, dmin, dmax, sigma, x0s, dVs
    ...
    def _lnlike(self, theta):
        ...
        spectra = [[self._spectrum(j, t, d, s, v, x0)
                    for d in dgrid for t in tgrid]
    ...
    def _spectrum(self, j, t, d, s, x, x0, mach=0.0):
